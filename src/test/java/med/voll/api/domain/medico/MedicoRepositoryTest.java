...
class MedicoRepositoryTest {
    ...
    @DisplayName("Deveria devolver null quando unico médico cadastrado não estiver disponível na data")
    @Test
    ...
    @DisplayName("Deveria devolver medico quando médico cadastrado estiver disponível na data")
    @Test
